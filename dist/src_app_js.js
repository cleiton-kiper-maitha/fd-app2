...
var MyComponent = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(MyComponent, [{
    ...
    value: function connectedCallback() {
      ...
      var handleDispatchEvent = function handleDispatchEvent(name) {
        var event = new CustomEvent("change-hello-name", {
          detail: name
        });
      ...
      react_dom__WEBPACK_IMPORTED_MODULE_1___default().render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Hello__WEBPACK_IMPORTED_MODULE_2__.default, {
